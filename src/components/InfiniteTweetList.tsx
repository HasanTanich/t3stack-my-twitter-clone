...
function TweetCard({
  ...
  const toggleFollow = api.profile.toggleFollow.useMutation({
    onSuccess: ({ addedFollow }) => {
      trpcUtils.profile.getById.setData({ id: user.id }, (oldData) => {
        if (oldData == null) return;
  ...
  return (
    <li className="flex gap-4 border-b-2 p-4">
      ...
      <div className="relative">
        <Select
          ...
          className="-left-52 top-0 font-normal"
